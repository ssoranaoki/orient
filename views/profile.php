            ...
            <div class="profile-area">
                <div class="top">
                    ...
                    <?php if ($view_user['id'] !== $view_requested_user['id']) : ?>
                        ...
                        <?php else : ?>
                            <button class="btn btn-sm btn-reverse js-follow"data-followed-user-id="<?php echo $view_requested_user['id']; ?>" data-follow-id="<?php echo $view_requested_user['follow_id']; ?>">フォローする</button>
                        <?php endif; ?>
                    <?php else : ?>
                        <!-- 自分のページ -->
